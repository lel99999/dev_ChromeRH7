...
#      ansible.playbook = "deploy_chromeRH7.yml"
##     ansible.groups = {
...
# end
  config.vm.define "chromeRH7" do |chromeRH7|
    chromeRH7.vm.box = "clouddood/RH7.5_baserepo"
    chromeRH7.vm.hostname = "emacsRH7"
    chromeRH7.vm.network "private_network", ip: "192.168.60.167"
#   chromeRH7.vm.network "private_network", ip: "192.168.60.167", nic_type: "virtio"
    chromeRH7.vm.provision "shell", :inline => "sudo echo '192.168.60.167 chromeRH7.local chromeRH7' >> /etc/hosts"

##  Use Main / Update in Vagrant provision command ### $vagrant provision --provision-with shell/main/update

    # Default
    chromeRH7.vm.provision "main", type: "ansible" do |ansible|
      ansible.playbook = "deploy_chromeRH7_DEV.local.yml"
#     ansible.playbook = "deploy_chromeRH7_DEV.local.yml"
#     ansible.playbook = "deploy_chromeTestRH7.yml"
    ...
    # Update
#   chromeRH7.vm.provision "update", type: "ansible" do |ansible|
